...
const formBuilder = (friend) => {
  const form = `
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" value="${friend.email}" id="form-friend-email" placeholder="jogn@gmail.com">
    </div>
    <div class="form-group">
      <label for="form-friend-phone">Phone Number: </label>
      <input type="text" class="form-control" value="${friend.phoneNumber}" id="form-friend-phone" placeholder="333-3339-3333">
    </div>
    <div class="form-group">
      <label for="form-friend-relationship">Relationship: </label>
      <input type="text" class="form-control" value="${friend.relationship}" id="form-friend-relationship" placeholder="complicated">
    </div>
  `;
  return form;
};
